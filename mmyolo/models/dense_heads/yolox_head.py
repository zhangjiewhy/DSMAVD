...
class YOLOXHead(YOLOv5Head):
    ...
    def loss_by_feat(
        ...
        # obj_targetsxx = obj_targets[0].detach().cpu().numpy()
        # obj_targetsxx1 = obj_targetsxx[0:6400, :].reshape(80, -1)
        # obj_targetsxx2 = obj_targetsxx[6400:8000, :].reshape(40, -1)
        # obj_targetsxx3 = obj_targetsxx[8000:8400, :].reshape(20, -1)
        #
        # pos_masksxx = pos_masks[0].unsqueeze(dim=1).detach().cpu().numpy()
        # cls_targetsxx1 = pos_masksxx[0:6400, :].reshape(80, 80)
        # pos_masksxx2 =pos_masksxx[6400:8000, :].reshape(40, 40)
        # pos_masksxx3 =pos_masksxx[8000:8400, :].reshape(20, 20)
