...
from .align_method import DCN_align_method

import mmcv


@MODELSS.register_module()
class DCN_Fus_Detector(SingleStageDetector):
    ...
    def __init__(self,
        ...
        self.align_method = self.DCN_align()
    ...
    def extract_feat(self, batch_inputs: Tensor) -> Tuple[Tensor]:
        ...
        if self.fusion_location == 'before_backbone':
            ...
            #                   out_file='/home/new/PycharmProjects/mmyolo/output/featmap/dcn_bn_x.jpg',
            #                   out_file_img='/home/new/PycharmProjects/mmyolo/output/featmap/原始.jpg',
            #                   drawn_img_i=drawn_img_i[0],
            #                   out_file_img_i='/home/new/PycharmProjects/mmyolo/output/featmap/原始_i.jpg',
            #                   )
            # self.save_featmap(flatten_featmaps=x_i,
            #                   drawn_img=drawn_img[0],
            #                   channel_reduction=channel_reduction,
            #                   out_file='/home/new/PycharmProjects/mmyolo/output/featmap/dcn_bn_xi.jpg')
            x_i = self.align_method_imple(x,x_i)
            x = self.feature_fusion(x, x_i, self.fusion_mode)
            # self.save_featmap(flatten_featmaps=x_i,
            #                   drawn_img=drawn_img[0],
            #                   channel_reduction=channel_reduction,
            #                   out_file='/home/new/PycharmProjects/mmyolo/output/featmap/dcn_bn_xi2.jpg')
            # self.save_featmap(flatten_featmaps=x,
            #                   drawn_img=drawn_img[0],
            #                   channel_reduction=channel_reduction,
            #                   out_file='/home/new/PycharmProjects/mmyolo/output/featmap/dcn_bn_xfus.jpg')
        ...
        if model == 'add':
            if self.fusion_location == 'before_backbone':
                ...
                for i in range(len(x)):
                    # x_fus.append(self.add_visxishu*x[i] + (1-self.add_visxishu)*x_i[i])
    ...
    def align_method_imple(self,x,x_i):
        xi = []
        for i in range(len(x)):
            xi.append(self.align_method[i](x[i], x_i[i]))
        return tuple(xi)
