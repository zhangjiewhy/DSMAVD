...
```
data/Armored_Vehicle2/test/test_infrared_imgt/155002.jpg \
python demo/featmap_vis_demo.py data/Armored_Vehicle2/test/test_infrared_imgt/155002.jpg \
                                configs/UACMDET/yolov5_s-v61_syncbn_fast_8xb16-300e_UACMDET.py \
                                checkpoint/best_coco_bbox_mAP_epoch_29.pth \
                                --target-layers neck \
                                --out-dir  ./output/UACMDET  \
