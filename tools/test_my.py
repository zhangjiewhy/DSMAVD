...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/FLIR_aling/yolov8_s_CMFIM_FLIR.py', help='test config file path')
    parser.add_argument('--checkpoint', default='/home/new/PycharmProjects/mmyolo/work_dirs/ATAV4_STATIC_SOFT_COMPUTING/FLIR/CFIM_ss=6_cs=1_bs=16/E300_LR=0.001_455776689(45.0)/best_coco_bbox_mAP_epoch_45.pth',help='checkpoint file')
    parser.add_argument(
        '--work-dir',
