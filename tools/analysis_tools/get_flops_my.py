...
def parse_args():
    ...
    parser.add_argument('--config',default='configs/RGBT/yolov8_s_syncbn_fast_8xb16-500e_RGBT.py',help='train config file path')
    parser.add_argument(
        '--shape',
        type=int,
        nargs='+',
...
def inference(args, logger):
    ...
    # model
    # print(cfg.model.type==RGBTDetector)
    ...
    if cfg.model.type=='RGBTDetector':
        data_batch = {'inputs': [torch.rand(6, h, w)], 'batch_samples': [None]}
