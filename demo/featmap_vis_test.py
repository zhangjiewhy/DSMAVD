...
def parse_args():
    ...
    parser.add_argument(
        '--img',default='./data/cat/images/IMG_20221020_112705.jpg', help='Image path, include image file, dir and URL.')
    parser.add_argument('--config',default='./configs/yolov5/yolov5_s-v61_fast_1xb12-40e_cat.py', help='Config file')
    parser.add_argument('--checkpoint',default='./work_dirs/yolov5_s-v61_fast_1xb12-40e_cat/epoch_40.pth', help='Checkpoint file')
    parser.add_argument(
