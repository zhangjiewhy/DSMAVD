...
def parse_args():
    ...
    # parser.add_argument('checkpoint', help='Checkpoint file')  #data/Armored_Vehicle2/test/test_infrared_imgt+
    parser.add_argument('--img', default='data/Armored_Vehicle2/test/test_vis/155002.jpg',type=str,help='Image path, include image file, dir and URL.')
    parser.add_argument('--config',default='configs/RGBT/yolov5/yolov5_s-v61_syncbn_fast_8xb16-300e_RGBT.py',type=str,help='Config file')
    parser.add_argument('--checkpoint',default='work_dirs/yolov5_s_fast/RGBT_noau_e30/concat_bh_bs8_lr0001_mixpre/best_coco_bbox_mAP_epoch_12.pth', type=str,help='Checkpoint file')
    parser.add_argument(
    ...
    parser.add_argument(
        '--channel-reduction',
        default='select_max',#squeeze_mean  select_max
...
def main():
    ...
    for image_path in image_list:
        ...
        if '+' in image_path:
            filename_i, image_path = image_path.split('+')
